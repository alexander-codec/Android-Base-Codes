package fr.kinemarts.camera.billing.utils;
...
public class SupportUtils {
     ...
     * @param listener a {@link fr.kinemarts.camera.billing.utils.SupportUtils.OnCheckSupportListener} used to deliver the response.
     */
