...
/**
 * A simple {@link android.support.v4.app.DialogFragment} used to ask the user to confirm the deletion of a {@link fr.kinemarts.camera.picker.data.ColorItem}.
 */
public final class DeleteColorDialogFragment extends DialogFragment {

    /**
     * The key used to pass the {@link fr.kinemarts.camera.picker.data.ColorItem} to delete as an argument.
     */
    private static final String ARG_COLOR_ITEM = "DeleteColorDialog.Args.ARG_COLOR_ITEM";

    /**
     * Create a new instance of a {@link DeleteColorDialogFragment} to ask the user to confirm the deletion of a {@link fr.kinemarts.camera.picker.data.ColorItem}.
     *
     * @param colorItemToDelete the {@link fr.kinemarts.camera.picker.data.ColorItem} to delete.
    ...
    /**
     * A {@link DeleteColorDialogFragment.Callback} used when the user confirms the deletion of a {@link fr.kinemarts.camera.picker.data.ColorItem}.
     */
    ...
    public interface Callback {
        ...
        /**
         * Called when the deletion of a {@link fr.kinemarts.camera.picker.data.ColorItem} has been confirmed by the user.
         *
         * @param colorItemToDelete the {@link fr.kinemarts.camera.picker.data.ColorItem} to delete.
         */
