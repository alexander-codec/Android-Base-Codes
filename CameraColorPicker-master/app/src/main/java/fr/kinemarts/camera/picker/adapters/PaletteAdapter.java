package fr.kinemarts.camera.picker.adapters;
...
public class PaletteAdapter extends ArrayAdapter<Palette> {
    ...
    /**
     * Create a {@link View} associated with a {@link fr.kinemarts.camera.picker.adapters.PaletteAdapter.ViewHolder}
    ...
    /**
     * Bind a {@link fr.kinemarts.camera.picker.adapters.PaletteAdapter.ViewHolder}
     * to the {@link Palette} at the given position.
     *
     * @param viewHolder the {@link fr.kinemarts.camera.picker.adapters.ColorItemAdapter.ViewHolder}.
