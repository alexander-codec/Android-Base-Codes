package fr.kinemarts.camera.picker.data;
...
/**
 * Static methods for dealing with {@link fr.kinemarts.camera.picker.data.ColorItem}s.
 */
public final class ColorItems {

    /**
     * A key for saving the {@link fr.kinemarts.camera.picker.data.ColorItem}s of the user.
     */
    ...
    /**
     * A {@link java.lang.reflect.Type} instance of a {@link java.util.List} of {@link fr.kinemarts.camera.picker.data.ColorItem}s.
     */
    private static final Type COLOR_ITEM_LIST_TYPE = new TypeToken<List<ColorItem>>() {
    }.getType();

    /**
     * A {@link java.util.Comparator} for sorting {@link fr.kinemarts.camera.picker.data.ColorItem}s in chronological order of creation.
     */
    ...
    /**
     * Get the {@link fr.kinemarts.camera.picker.data.ColorItem}s of the user.
     *
     * @param context a {@link android.content.Context}.
     * @return a {@link java.util.List} of {@link fr.kinemarts.camera.picker.data.ColorItem}s.
     */
     ...
     * Get the {@link fr.kinemarts.camera.picker.data.ColorItem}s of the user.
     *
     * @param sharedPreferences a {@link android.content.SharedPreferences} from which the {@link fr.kinemarts.camera.picker.data.ColorItem}s will be retrieved.
     * @return a {@link java.util.List} of {@link fr.kinemarts.camera.picker.data.ColorItem}s.
     */
    ...
    /**
     * Save a {@link fr.kinemarts.camera.picker.data.ColorItem}s.
     *
     * @param context     a {@link android.content.Context}.
     * @param colorToSave the {@link fr.kinemarts.camera.picker.data.ColorItem} to save.
     * @return Returns true if the new {@link fr.kinemarts.camera.picker.data.ColorItem} was successfully written to persistent storage.
     */
    ...
    /**
     * Delete a {@link fr.kinemarts.camera.picker.data.ColorItem}.
     *
     * @param context           a {@link android.content.Context}.
     * @param colorItemToDelete the {@link fr.kinemarts.camera.picker.data.ColorItem} to be deleted.
    ...
    /**
     * Register a {@link fr.kinemarts.camera.picker.data.ColorItems.OnColorItemChangeListener}.
     * <p/>
     ...
     *
     * @param context                   a {@link android.content.Context}.
     * @param onColorItemChangeListener the {@link fr.kinemarts.camera.picker.data.ColorItems.OnColorItemChangeListener} to register.
     */
    ...
    /**
     * Unregister a {@link fr.kinemarts.camera.picker.data.ColorItems.OnColorItemChangeListener}.
     *
     * @param context                   a {@link android.content.Context}.
     * @param onColorItemChangeListener the {@link fr.kinemarts.camera.picker.data.ColorItems.OnColorItemChangeListener} to unregister.
     */
    ...
    /**
     * A simple class for listening to the changes of the {@link fr.kinemarts.camera.picker.data.ColorItem}s of the user.
     */
    public abstract static class OnColorItemChangeListener implements SharedPreferences.OnSharedPreferenceChangeListener {
        ...
        /**
         * Called when the {@link fr.kinemarts.camera.picker.data.ColorItem}s of the user have just changed.
         *
         * @param colorItems the current {@link java.util.List} of the {@link fr.kinemarts.camera.picker.data.ColorItem}s of the user.
         */
