package fr.kinemarts.camera.picker.views;
...
import fr.kinemarts.camera.picker.R;
import fr.kinemarts.camera.picker.activities.ColorDetailActivity;
import fr.kinemarts.camera.picker.adapters.ColorItemAdapter;
import fr.kinemarts.camera.picker.data.ColorItem;
import fr.kinemarts.camera.picker.data.ColorItems;
import fr.kinemarts.camera.picker.utils.ClipDatas;

/**
 * A simple {@link FrameLayout} used in the {@link android.support.v4.view.ViewPager} of the {@link fr.kinemarts.camera.picker.activities.MainActivity}
 * to display the list of the {@link ColorItem}s that the user created.
 */
public class ColorItemListPage extends FrameLayout {

    /**
     * A {@link ColorItemAdapter} used for adapting the {@link fr.kinemarts.camera.picker.data.ColorItem}s.
     */
    private ColorItemAdapter mColorItemAdapter;

    /**
     * A {@link android.widget.ListView} used for displaying the {@link fr.kinemarts.camera.picker.data.ColorItem}s
     */
    private ListView mListView;

    /**
     * A {@link fr.kinemarts.camera.picker.data.ColorItems.OnColorItemChangeListener} for listening the creation of new {@link fr.kinemarts.camera.picker.data.ColorItem}s.
     */
    private ColorItems.OnColorItemChangeListener mOnColorItemChangeListener;

    /**
     * The user-visible label for the clip {@link fr.kinemarts.camera.picker.data.ColorItem}.
     */
