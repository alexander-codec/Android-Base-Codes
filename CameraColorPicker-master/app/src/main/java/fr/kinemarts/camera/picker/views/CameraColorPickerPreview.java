...
public class CameraColorPickerPreview extends TextureView implements TextureView.SurfaceTextureListener, Camera.PreviewCallback {
    ...
    /**
     * An {@link fr.kinemarts.camera.picker.views.CameraColorPickerPreview.OnColorSelectedListener} that will be called each time a new color is being selected.
     */
    ...
    /**
     * Set a {@link fr.kinemarts.camera.picker.views.CameraColorPickerPreview.OnColorSelectedListener} that will be called each time a new color is selected.
     *
     * @param onColorSelectedListener the {@link fr.kinemarts.camera.picker.views.CameraColorPickerPreview.OnColorSelectedListener} that will be called.
     */
