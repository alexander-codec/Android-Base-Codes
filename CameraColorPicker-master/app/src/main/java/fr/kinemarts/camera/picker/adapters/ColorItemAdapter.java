...
public class ColorItemAdapter extends ArrayAdapter<ColorItem> {
    ...
    /**
     * Create a {@link View} associated with a {@link fr.kinemarts.camera.picker.adapters.ColorItemAdapter.ViewHolder}
    ...
    /**
     * Bind a {@link fr.kinemarts.camera.picker.adapters.ColorItemAdapter.ViewHolder}
