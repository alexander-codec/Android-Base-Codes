package fr.kinemarts.camera.picker.utils;
...
public final class Versions {
     ...
     * @return the version name of the application or {@link fr.kinemarts.camera.picker.utils.Versions#DEFAULT_VERSION_NAME}.
     */
