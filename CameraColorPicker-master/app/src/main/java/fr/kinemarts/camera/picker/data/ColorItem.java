...
public class ColorItem implements Parcelable {
    ...
    /**
     * Create a new {@link fr.kinemarts.camera.picker.data.ColorItem} with an id and a color.
     *
     * @param id    the id of the {@link fr.kinemarts.camera.picker.data.ColorItem}. Should be unique.
    ...
    /**
     * Create a new {@link fr.kinemarts.camera.picker.data.ColorItem} from a {@link android.os.Parcel}.
     * <p/>
     * Used by the parcelable creator.
     * {@link fr.kinemarts.camera.picker.data.ColorItem#CREATOR}.
     *
    ...
    /**
     * Create a new {@link fr.kinemarts.camera.picker.data.ColorItem} with a color.
     * <p/>
     * The {@link fr.kinemarts.camera.picker.data.ColorItem#mId} is set to the {@link fr.kinemarts.camera.picker.data.ColorItem#mCreationTime}.
     *
     * @param color the color value.
     */
    ...
    /**
     * Get the id of the {@link fr.kinemarts.camera.picker.data.ColorItem}.
     *
     * @return the id of the {@link fr.kinemarts.camera.picker.data.ColorItem}.
     */
    public long getId() {
        return mId;
    }
    ...
    /**
     * Get the value of the {@link fr.kinemarts.camera.picker.data.ColorItem}.
     *
     * @return an integer representing the color value of the {@link fr.kinemarts.camera.picker.data.ColorItem}.
     */
    public int getColor() {
        return mColor;
    }
    ...
    /**
     * Set the color valur of the {@link fr.kinemarts.camera.picker.data.ColorItem}.
     *
     * @param color an integer representing the new color value of the {@link fr.kinemarts.camera.picker.data.ColorItem}.
     */
    ...
    /**
     * Get the creation time of the {@link fr.kinemarts.camera.picker.data.ColorItem}.
     *
    ...
    /**
     * A {@link android.os.Parcelable.Creator} for creating {@link fr.kinemarts.camera.picker.data.ColorItem} from {@link android.os.Parcel}.
     */
