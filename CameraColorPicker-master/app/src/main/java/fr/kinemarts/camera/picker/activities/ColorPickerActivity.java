...
import fr.kinemarts.camera.picker.utils.Cameras;
import fr.kinemarts.camera.picker.views.CameraColorPickerPreview;
...
public class ColorPickerActivity extends AppCompatActivity implements CameraColorPickerPreview.OnColorSelectedListener, View.OnClickListener {
     ...
     * <p/>
     * Used by {@link fr.kinemarts.camera.picker.activities.ColorPickerActivity#mPickedColorProgressAnimator}.
     */
     ...
     * <p/>
     * Used by {@link fr.kinemarts.camera.picker.activities.ColorPickerActivity#mSaveCompletedProgressAnimator}.
     */
    ...
    /**
     * The {@link fr.kinemarts.camera.picker.views.CameraColorPickerPreview} used for the preview.
     */
    protected CameraColorPickerPreview mCameraPreview;

    /**
     * A reference to the {@link fr.kinemarts.camera.picker.activities.ColorPickerActivity.CameraAsyncTask} that gets the {@link android.hardware.Camera}.
     */
