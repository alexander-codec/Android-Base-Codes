package fr.kinemarts.camera.picker.fragments;
...
import fr.kinemarts.camera.picker.data.Palette;
import fr.kinemarts.camera.picker.views.PaletteView;

/**
 * A simple {@link android.support.v4.app.DialogFragment} used to ask the user to confirm the deletion of a {@link fr.kinemarts.camera.picker.data.Palette}.
 */
public class DeletePaletteDialogFragment extends DialogFragment {

    /**
     * The key used to pass the {@link fr.kinemarts.camera.picker.data.Palette} to delete as an argument.
     */
    private static final String ARG_PALETTE = "DeletePaletteDialogFragment.Args.ARG_PALETTE";

    /**
     * Create a new instance of a {@link DeletePaletteDialogFragment} to ask the user to confirm the deletion of a {@link fr.kinemarts.camera.picker.data.Palette}.
     *
     * @param paletteToDelete the {@link fr.kinemarts.camera.picker.data.Palette} to delete.
    ...
    /**
     * A {@link DeletePaletteDialogFragment.Callback} used when the user confirms the deletion of a {@link fr.kinemarts.camera.picker.data.Palette}.
     */
    ...
    public interface Callback {
        ...
        /**
         * Called when the deletion of a {@link fr.kinemarts.camera.picker.data.Palette} has been confirmed by the user.
         *
         * @param paletteToDelete the {@link fr.kinemarts.camera.picker.data.Palette} to delete.
         */
