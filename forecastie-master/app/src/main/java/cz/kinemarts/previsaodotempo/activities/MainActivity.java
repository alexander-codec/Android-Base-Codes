package cz.kinemarts.previsaodotempo.activities;
...
import cz.kinemarts.previsaodotempo.AlarmReceiver;
import cz.kinemarts.previsaodotempo.Constants;
import cz.kinemarts.previsaodotempo.R;
import cz.kinemarts.previsaodotempo.adapters.ViewPagerAdapter;
import cz.kinemarts.previsaodotempo.adapters.WeatherRecyclerAdapter;
import cz.kinemarts.previsaodotempo.fragments.RecyclerViewFragment;
import cz.kinemarts.previsaodotempo.models.Weather;
import cz.kinemarts.previsaodotempo.tasks.GenericRequestTask;
import cz.kinemarts.previsaodotempo.tasks.ParseResult;
import cz.kinemarts.previsaodotempo.tasks.TaskOutput;
import cz.kinemarts.previsaodotempo.utils.UnitConvertor;
import cz.kinemarts.previsaodotempo.widgets.AbstractWidgetProvider;
import cz.kinemarts.previsaodotempo.widgets.DashClockWeatherExtension;
...
public class MainActivity extends AppCompatActivity implements LocationListener {
    ...
    private void aboutDialog() {
        AlertDialog.Builder alert = new AlertDialog.Builder(this);
        alert.setTitle("Previsão do Tempo");
