...
public class AppConstants {
    ...
    public static final String APP_DIR                    = Environment.getExternalStorageDirectory() + "/CameraEditor";
    public static final String APP_TEMP                   = APP_DIR + "/temp";
    public static final String APP_IMAGE                  = APP_DIR + "/imagens";
